...
if __name__ == '__main__':
    ...
    parser.add_argument("--output_dir", default='./data/models/snips_student_2', type=str,
                        help="Path to save, load model")
    parser.add_argument("--teacher_model", default='./data/models/bert-base-uncased', type=str,
                        help="The teacher model dir.")
    parser.add_argument("--student_model", default='./data/models/snips_student', type=str,
